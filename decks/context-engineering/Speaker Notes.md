...
## Delivery rules (from v1 review)

- **Cut fillers.** When you feel "um / so / like" coming, **pause** instead. The audience's mind races to fill the gap — that's the moment they pay closest attention. Pause, breathe, gather the next sentence, then continue.
- **Front-load the punchline.** The thesis slide (slide 2) states it up front: *"Your AI is only as good as the context you give it."* Say it slowly. Then prove it. The closing bookends — same line again, but now they have the proof.
- **Watch the recording before the next round.** Mark every filler. Practice the same content with deliberate pauses where the fillers were.
...
| 2 | **Thesis** | ~20s | **Front-load the punchline.** Say it once, slowly. Pause. |
| 3 | "Why does my chat get worse?" | ~30s | Pause. Let it land. Look up. |
| 4 | Prompt → Context Engineering | ~1 min | The shift. Karpathy/Lütke. |
| 5 | Anatomy of context | ~1 min | The bar diagram. "Your message is 1%." |
| 6 | "Hi" — same prompt, different result | ~1 min | The turning-point slide. |
| 7 | Too little context | ~45s | Calendar example. Robot vs assistant. |
| 8 | Too much context | ~1.5 min | Three findings. Bottom line: hallucinations. |
| 9 | Claude vs ChatGPT memory | ~1 min | Both auto-sync now. Use Projects. |
| 10 | 5 habits to take home | ~1.5 min | The takeaway. Slow down here. |
| 11 | Bonus: tell it what to do | ~45s | White bear. (Q&A request from a teammate.) |
| 12 | Closing | ~30s | Bookend the thesis. Q&A. |
...
### 2. Thesis
**Say it once, slowly. Pause. This is the front-loaded punchline.**

"Here's the whole talk in one line: *your AI is only as good as the context you give it*."

Pause. Look up. "Everything else I'm about to show you is proof of that — and what to do about it."

Then transition into slide 3.
...
"That's the whole talk in one line — same one I opened with."

### 5. Anatomy of context
...
### 12. Closing
**Bookend the thesis. Same line as slide 2 — but now they have the proof.**

"So back to where we started: *your AI is only as good as the context you give it*. Curate it like you'd brief a new hire on Day 1 — what they need, what they don't, and where to find the rest."
...
- Cut slide 7 (merge the calendar example as a one-liner into slide 6).
- Shorten slide 9 to a single sentence: "Both have memory; use Projects."
...
- Pause on slide 2 after the thesis. Let it land before launching into the problem.
- Pause after slide 3's question. The audience needs to feel the recognition.
- Don't read slide 8's bullets verbatim — paraphrase.
- Slide 10 is the one slide they should photograph. Slow down. Land each habit.
- **No fillers.** When you reach for "um / so / like" — pause instead.
